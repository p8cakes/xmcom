...
if (array_key_exists("xm_session", $_SESSION)) {
...
?>" style="border: 0;"><img style="position:absolute; top:5px; left:5px; width:150px; height:108px; border:0" alt="XM" src="images/xm.png" /></a>
<table style="border: 0px; width: 100%; background-color: #BBBBBB;">
  <tbody>
    <tr>
...
<div class="bannerContent">
  <span style="margin-left: 165px; margin-top: 25px; font-family: Calibri,Verdana,Arial">XM<br/></span>
