...
//
// File: LogUserAccess.php - log user access being performed for this user
//
// Input JSON:
// {"request":{
...
// Authorized client is running locally, and attempting to post with a valid API_KEY
if ((isset($_SERVER["HTTP_APIKEY"])) &&
    ($_SERVER["HTTP_APIKEY"] === "e6ca4533012d418b8a93ec3abd5cbb9c") &&                     // $$ API_KEY $$
    ...
    if ($postBody !== "") {
        ...
        // die("postBody: " . $postBody);

        if (isset($request["browserString"])) {
            $userAgent = $request["browserString"];
        }
